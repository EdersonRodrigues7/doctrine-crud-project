 ...
 */
final class Version20240721002032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Course (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE Phone (id INT AUTO_INCREMENT NOT NULL, number VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, student_id INT DEFAULT NULL, INDEX IDX_858EB8D9CB944F1A (student_id), PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE Student (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
